...
export async function getUserInfo(params: GetUserInfoParams) {
  try {
    ...
    const criteria = [
      { type: "QUESTION_COUNT" as BadgeCriteriaType, value: totalQuestions },
      { type: "ANSWER_COUNT" as BadgeCriteriaType, value: totalAnswers },
      {
        type: "QUESTION_UPVOTES" as BadgeCriteriaType,
        value: questionUpvotes?.totalUpvotes || 0,
      },
      {
        type: "ANSWER_UPVOTES" as BadgeCriteriaType,
        value: answerUpvotes?.totalUpvotes || 0,
      },
      {
        type: "TOTAL_VIEWS" as BadgeCriteriaType,
        value: questionViews?.totalViews || 0,
      },
    ];
